...
describe("isAllowedOrigin", () => {
  it("allows the exact production + web.app origins", () => {
    expect(isAllowedOrigin("https://flygaca.com")).toBe(true);
    expect(isAllowedOrigin("https://www.flygaca.com")).toBe(true);
    expect(isAllowedOrigin("https://flygaca-app.web.app")).toBe(true);
  });
  ...
  it("allows https project-scoped preview suffixes", () => {
    expect(isAllowedOrigin("https://preview.flygaca-app.web.app")).toBe(true);
    expect(isAllowedOrigin("https://flygaca-app-git-branch-flygaca-app.vercel.app")).toBe(true);
  });

  it("rejects look-alike hosts that only end with a bare domain", () => {
    expect(isAllowedOrigin("https://evil-flygaca-app.web.app")).toBe(false);
  ...
  it("rejects a non-https preview origin and unknown origins", () => {
    expect(isAllowedOrigin("http://preview--flygaca-app.web.app")).toBe(false);
